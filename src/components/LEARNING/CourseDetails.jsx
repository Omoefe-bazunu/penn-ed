    ...
    <>
      <div className="posts w-full h-fit py-5 px-5 border">
        ...
        <div className=" flex gap-2 items-center mb-4">
          <p className="text-white text-xs italic opacity-60 text-nowrap">
            - Toggle the symbols to open and close the content -
          </p>
        ...
        <div className="post-content" style={contentStyle}>
          ...
          <p className="postBody text-white whitespace-pre-wrap mb-4">
            {course.body}
          </p>
        </div>
      </div>
