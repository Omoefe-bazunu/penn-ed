// src/components/forms/UpdateCourseForm.jsx
...
function UpdateCourseForm({ isOpen, onClose, course }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateDoc(doc(dbase, "courses", course.id), {
  ...
  const handleDelete = async () => {
    ...
    if (window.confirm("Are you sure you want to delete this course?")) {
      try {
        ...
        await deleteDoc(doc(dbase, "courses", course.id));
